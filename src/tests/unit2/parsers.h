...
void api_test_parser_memcached() {
    ...
    metric_test_run(CMP_EQUAL, "memcached_uptime_seconds", "memcached_uptime_seconds", 28);
    metric_test_run(CMP_GREATER, "memcached_time_seconds", "memcached_time_seconds", 0);
    metric_test_run(CMP_EQUAL, "memcached_pointer_size", "memcached_pointer_size", 64);
    metric_test_run(CMP_EQUAL, "memcached_rusage_seconds_total{type=\"user\"}", "memcached_rusage_seconds_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_rusage_seconds_total{type=\"system\"}", "memcached_rusage_seconds_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_current_connections", "memcached_current_connections", 10);
    metric_test_run(CMP_EQUAL, "memcached_connections_total", "memcached_connections_total", 12);
    ...
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"get\",status=\"hit\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"get\",status=\"miss\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"set\",status=\"hit\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"flush\",status=\"hit\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"delete\",status=\"hit\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"delete\",status=\"miss\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"incr\",status=\"hit\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"incr\",status=\"miss\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"decr\",status=\"hit\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"decr\",status=\"miss\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"cas\",status=\"hit\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"cas\",status=\"miss\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"cas\",status=\"badval\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"touch\",status=\"hit\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_commands_total{command=\"touch\",status=\"miss\"}", "memcached_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_auth_commands_total", "memcached_auth_commands_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_auth_errors_total", "memcached_auth_errors_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_read_bytes_total", "memcached_read_bytes_total", 12);
    metric_test_run(CMP_GREATER, "memcached_written_bytes_total", "memcached_written_bytes_total", 0);
    metric_test_run(CMP_GREATER, "memcached_limit_bytes", "memcached_limit_bytes", 0);
    metric_test_run(CMP_EQUAL, "memcached_accepting_connections", "memcached_accepting_connections", 1);
    metric_test_run(CMP_EQUAL, "memcached_connections_listener_disabled_total", "memcached_connections_listener_disabled_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_threads", "memcached_threads", 4);
    metric_test_run(CMP_EQUAL, "memcached_connections_yielded_total", "memcached_connections_yielded_total", 0);
    ...
    metric_test_run(CMP_EQUAL, "memcached_current_bytes", "memcached_current_bytes", 0);
    metric_test_run(CMP_EQUAL, "memcached_current_items", "memcached_current_items", 0);
    metric_test_run(CMP_EQUAL, "memcached_items_total", "memcached_items_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_items_expired_unfetched_total", "memcached_items_expired_unfetched_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_items_evicted_unfetched_total", "memcached_items_evicted_unfetched_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_items_evicted_total", "memcached_items_evicted_total", 0);
    metric_test_run(CMP_EQUAL, "memcached_items_reclaimed_total", "memcached_items_reclaimed_total", 0);
