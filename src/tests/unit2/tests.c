...
static void run_config_query_suites(char **argv)
{
    ...
    api_test_parser_openvpn();
    api_test_parser_opennebula();
    api_test_parser_chrony();
    api_test_parser_dnsmasq();
    api_test_parser_dnsmasq_dhcp();
    api_test_parser_freeradius();
    api_test_parser_postfix();
    api_test_parser_openclaw();
...
static void run_helpers_and_events_suites(void)
{
    ...
    test_vrl_enrichment_and_secrets();
    test_mkdirp_helpers();
