...
statsd_send 'top100.chapi.response_code:1|c|#status_code:200,endpoint:/api/report/v1.0/ch_geo?geo_ids=1,method:GET,2=3'
curl_no_test 'top100_chapi_response_code {2="3", status_code="200", endpoint="/api/report/v1.0/ch_geo?geo_ids=1", method="GET"} 1.000000'
...
statsd_send 'test3.tata.test4.papa:655.000000|ms'
curl_test 'tata_papa'
