...
printf '# TYPE test_kafka_consume gauge\ntest_kafka_consume 42\n' | \
	sh "$KAFKA_HOME/bin/kafka-console-producer.sh" --broker-list 127.0.0.1:9092 --topic "$TOPIC"
