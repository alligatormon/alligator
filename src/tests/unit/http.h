...
{
	char* query;
	query = gen_http_query(0, "/", NULL, "example.com", "testagent", NULL, 0, NULL);
...
{
	char* query;
	query = gen_http_query(0, "/api/v.1.3.4/query/?action=delete&button=pressed&dns=ok&request_id=oaqu7EoX", NULL, "EX.WWW.NEW.EXAMPLE.NET", "TeSTageNt/12.3.4 \\ (Test Ag. Ltd.) \\", NULL, 0, NULL);
...
{
	char* query;
	query = gen_http_query(0, "/api/v.1.3.4/query/?action=delete&button=pressed&dns=ok&request_id=oaqu7EoX", NULL, "EX.WWW.NEW.EXAMPLE.NET", "TeSTageNt/12.3.4 \\ (Test Ag. Ltd.) \\", "dXNkcjpwYXNz", 0, NULL);
