...
static void system_register_metric_families(context_arg *carg)
{
	...
	namespace_metric_family_set(NULL, carg, "zfs_arc_stat", METRIC_TYPE_COUNTER, "ZFS ARC cumulative counters from /proc/spl/kstat/zfs/arcstats.");
	namespace_metric_family_set(NULL, carg, "zfs_arc_bytes", METRIC_TYPE_GAUGE, "ZFS ARC size and target in bytes from /proc/spl/kstat/zfs/arcstats.");
	namespace_metric_family_set(NULL, carg, "zfs_zpool_state", METRIC_TYPE_GAUGE, "ZFS pool health one-hot gauge from /proc/spl/kstat/zfs/<pool>/state.");
	namespace_metric_family_set(NULL, carg, "zfs_dmu_tx_stat", METRIC_TYPE_COUNTER, "ZFS DMU transaction counters from /proc/spl/kstat/zfs/dmu_tx.");
	namespace_metric_family_set(NULL, carg, "zfs_zil_stat", METRIC_TYPE_COUNTER, "ZFS intent-log counters from /proc/spl/kstat/zfs/zil.");
	...
	namespace_metric_family_set(NULL, carg, "pressure_waiting_seconds_total", METRIC_TYPE_COUNTER, "PSI some-total stall time in seconds by resource (cpu, memory, io, irq).");
	...
	namespace_metric_family_set(NULL, carg, "ksm", METRIC_TYPE_GAUGE, "Kernel Samepage Merging gauges and tunables from /sys/kernel/mm/ksm by stat name.");
	namespace_metric_family_set(NULL, carg, "ksm_stat_total", METRIC_TYPE_COUNTER, "Cumulative KSM counters from /sys/kernel/mm/ksm (full_scans, pages_scanned).");
	namespace_metric_family_set(NULL, carg, "zram_bytes", METRIC_TYPE_GAUGE, "zram device sizes in bytes from /sys/block/zram* (disksize, orig/compr data, mem used, backing device).");
	namespace_metric_family_set(NULL, carg, "zram_stat", METRIC_TYPE_GAUGE, "zram device gauges from /sys/block/zram* (same_pages, huge_pages, initstate).");
	namespace_metric_family_set(NULL, carg, "zram_stat_total", METRIC_TYPE_COUNTER, "zram device counters from /sys/block/zram* (compacted/huge pages, failed I/O, notify_free).");
	namespace_metric_family_set(NULL, carg, "zram_comp_algorithm", METRIC_TYPE_GAUGE, "Active zram compression algorithm (value 1) from /sys/block/zram*/comp_algorithm.");
	...
	namespace_metric_family_set(NULL, carg, "wifi_station_info", METRIC_TYPE_GAUGE, "Associated BSS labels (bssid, ssid, mode) from nl80211 scan dump.");
	namespace_metric_family_set(NULL, carg, "wifi_station_signal_dbm", METRIC_TYPE_GAUGE, "Station RSSI in dBm from nl80211.");
	namespace_metric_family_set(NULL, carg, "wifi_station_receive_bytes_total", METRIC_TYPE_COUNTER, "Station receive bytes from nl80211.");
	namespace_metric_family_set(NULL, carg, "wifi_station_transmit_bytes_total", METRIC_TYPE_COUNTER, "Station transmit bytes from nl80211.");
	namespace_metric_family_set(NULL, carg, "wifi_station_receive_packets_total", METRIC_TYPE_COUNTER, "Station receive packets from nl80211.");
	namespace_metric_family_set(NULL, carg, "wifi_station_transmit_packets_total", METRIC_TYPE_COUNTER, "Station transmit packets from nl80211.");
	namespace_metric_family_set(NULL, carg, "wifi_station_transmit_retries_total", METRIC_TYPE_COUNTER, "Station transmit retries from nl80211.");
	namespace_metric_family_set(NULL, carg, "wifi_station_transmit_failed_total", METRIC_TYPE_COUNTER, "Station transmit failures from nl80211.");
	namespace_metric_family_set(NULL, carg, "wifi_station_beacon_loss_total", METRIC_TYPE_COUNTER, "Station beacon loss count from nl80211.");
	namespace_metric_family_set(NULL, carg, "wifi_station_connected_seconds_total", METRIC_TYPE_COUNTER, "Seconds the station has been connected.");
	namespace_metric_family_set(NULL, carg, "wifi_station_inactive_seconds", METRIC_TYPE_GAUGE, "Seconds since last station activity.");
	namespace_metric_family_set(NULL, carg, "wifi_station_receive_bits_per_second", METRIC_TYPE_GAUGE, "Station receive bitrate in bits per second.");
	namespace_metric_family_set(NULL, carg, "wifi_station_transmit_bits_per_second", METRIC_TYPE_GAUGE, "Station transmit bitrate in bits per second.");
	...
	namespace_metric_family_set(NULL, carg, "bonding_lacp", METRIC_TYPE_GAUGE, "Bonding LACP attributes by master and stat name.");
	namespace_metric_family_set(NULL, carg, "hugepages_total", METRIC_TYPE_GAUGE, "HugeTLB page count from meminfo HugePages_Total.");
	namespace_metric_family_set(NULL, carg, "hugepages_free", METRIC_TYPE_GAUGE, "HugeTLB free page count from meminfo HugePages_Free.");
	namespace_metric_family_set(NULL, carg, "hugepages_rsvd", METRIC_TYPE_GAUGE, "HugeTLB reserved page count from meminfo HugePages_Rsvd.");
	namespace_metric_family_set(NULL, carg, "hugepages_surp", METRIC_TYPE_GAUGE, "HugeTLB surplus page count from meminfo HugePages_Surp.");
	namespace_metric_family_set(NULL, carg, "hugepages_size_bytes", METRIC_TYPE_GAUGE, "Default huge page size in bytes from meminfo Hugepagesize.");
	namespace_metric_family_set(NULL, carg, "anon_hugepages_bytes", METRIC_TYPE_GAUGE, "Anonymous transparent huge pages in bytes.");
	namespace_metric_family_set(NULL, carg, "hugepages_nr", METRIC_TYPE_GAUGE, "HugeTLB page counts by size and type from sysfs.");
	namespace_metric_family_set(NULL, carg, "synproxy_stat_total", METRIC_TYPE_COUNTER, "Netfilter SYNPROXY counters from /proc/net/stat/synproxy.");
	namespace_metric_family_set(NULL, carg, "raid_part", METRIC_TYPE_GAUGE, "MD RAID member device presence by array and device.");
	namespace_metric_family_set(NULL, carg, "raid_configuration", METRIC_TYPE_GAUGE, "MD RAID array configuration marker by array, status, and level.");
	namespace_metric_family_set(NULL, carg, "raid_size_bytes", METRIC_TYPE_GAUGE, "MD RAID array size in bytes.");
	namespace_metric_family_set(NULL, carg, "raid_devices", METRIC_TYPE_GAUGE, "MD RAID device counts by array and type (current, full).");
	namespace_metric_family_set(NULL, carg, "raid_status", METRIC_TYPE_GAUGE, "MD RAID healthy status (1=ok).");
	namespace_metric_family_set(NULL, carg, "raid_rebuild_percent", METRIC_TYPE_GAUGE, "MD RAID rebuild/resync percent complete.");
	namespace_metric_family_set(NULL, carg, "raid_rebuild_finish_seconds", METRIC_TYPE_GAUGE, "Estimated MD RAID rebuild remaining time in seconds.");
	namespace_metric_family_set(NULL, carg, "raid_rebuild_speed_bytes", METRIC_TYPE_GAUGE, "MD RAID rebuild speed in bytes per second.");
	namespace_metric_family_set(NULL, carg, "cpu_frequency_hertz", METRIC_TYPE_GAUGE, "CPU frequency in hertz from cpufreq sysfs by cpu and type.");
	namespace_metric_family_set(NULL, carg, "cpu_throttle_count", METRIC_TYPE_COUNTER, "CPU thermal throttle event count by cpu.");
	namespace_metric_family_set(NULL, carg, "cpu_throttle_seconds_total", METRIC_TYPE_COUNTER, "CPU thermal throttle time in seconds by cpu.");
	namespace_metric_family_set(NULL, carg, "cpu_cstate_seconds_total", METRIC_TYPE_COUNTER, "Time spent in a CPU idle C-state in seconds from cpuidle sysfs time (microseconds).");
	namespace_metric_family_set(NULL, carg, "cpu_cstate_usage_total", METRIC_TYPE_COUNTER, "Number of times a CPU entered an idle C-state from cpuidle sysfs usage.");
	namespace_metric_family_set(NULL, carg, "cpu_cstate_disabled", METRIC_TYPE_GAUGE, "Whether a CPU idle C-state is disabled (1) from cpuidle sysfs disable.");
	namespace_metric_family_set(NULL, carg, "cpu_cstate_driver", METRIC_TYPE_GAUGE, "Active cpuidle driver name from /sys/devices/system/cpu/cpuidle/current_driver.");
	namespace_metric_family_set(NULL, carg, "cpu_cstate_governor", METRIC_TYPE_GAUGE, "Active cpuidle governor from /sys/devices/system/cpu/cpuidle/current_governor.");
	namespace_metric_family_set(NULL, carg, "hwmon_power_watt", METRIC_TYPE_GAUGE, "hwmon power sensor reading in watts.");
	namespace_metric_family_set(NULL, carg, "hwmon_fan_rpm", METRIC_TYPE_GAUGE, "hwmon fan speed in RPM.");
	namespace_metric_family_set(NULL, carg, "lvm_lv_size_bytes", METRIC_TYPE_GAUGE, "LVM logical volume size in bytes from device-mapper sysfs.");
	namespace_metric_family_set(NULL, carg, "lvm_lv_suspended", METRIC_TYPE_GAUGE, "Whether an LVM logical volume is suspended.");
	namespace_metric_family_set(NULL, carg, "wireguard_device_listen_port", METRIC_TYPE_GAUGE, "WireGuard device listen port.");
	namespace_metric_family_set(NULL, carg, "wireguard_device_peers", METRIC_TYPE_GAUGE, "Number of WireGuard peers on a device.");
	namespace_metric_family_set(NULL, carg, "wireguard_peer_rx_bytes", METRIC_TYPE_COUNTER, "WireGuard peer receive bytes.");
	namespace_metric_family_set(NULL, carg, "wireguard_peer_tx_bytes", METRIC_TYPE_COUNTER, "WireGuard peer transmit bytes.");
	namespace_metric_family_set(NULL, carg, "wireguard_peer_last_handshake_seconds", METRIC_TYPE_GAUGE, "Unix timestamp of last WireGuard peer handshake.");
	...
	namespace_metric_family_set(NULL, carg, "ethtool_stat", METRIC_TYPE_COUNTER, "Driver-defined NIC statistics from ethtool ioctl (ethtool -S).");
	namespace_metric_family_set(NULL, carg, "nfs_mount_age_seconds", METRIC_TYPE_GAUGE, "Age of an NFS mount in seconds from /proc/self/mountstats.");
	namespace_metric_family_set(NULL, carg, "nfs_mount_info", METRIC_TYPE_GAUGE, "NFS mount presence (value 1) with export, mountpoint, and protocol labels.");
	namespace_metric_family_set(NULL, carg, "nfs_mount_bytes_total", METRIC_TYPE_COUNTER, "NFS mount byte and page counters from mountstats bytes: by type.");
	namespace_metric_family_set(NULL, carg, "nfs_mount_event_total", METRIC_TYPE_COUNTER, "NFS mount VFS/cache event counters from mountstats events: by type.");
	namespace_metric_family_set(NULL, carg, "nfs_mount_transport_total", METRIC_TYPE_COUNTER, "NFS RPC transport counters from mountstats xprt: by protocol and type.");
	namespace_metric_family_set(NULL, carg, "nfs_mount_transport_idle_seconds", METRIC_TYPE_GAUGE, "Seconds since last RPC traffic on an NFS mount transport.");
	namespace_metric_family_set(NULL, carg, "nfs_mount_transport_max_slots", METRIC_TYPE_GAUGE, "Maximum simultaneous NFS RPC slots used on a mount transport.");
	namespace_metric_family_set(NULL, carg, "nfs_mount_ops_total", METRIC_TYPE_COUNTER, "NFS per-operation request/transmission/byte/error counters from mountstats.");
	namespace_metric_family_set(NULL, carg, "nfs_mount_ops_seconds_total", METRIC_TYPE_COUNTER, "NFS per-operation cumulative queue/RTT/execute time in seconds from mountstats.");
